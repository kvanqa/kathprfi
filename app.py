...
app.layout = html.Div([
    ...
    html.Ul([
	html.Li(html.A("December 2022 Dataset", href="/assets/fractional_RFI_December_2022.csv", target="_blank")),
        html.Li(html.A("August 2024 Dataset", href="/assets/fractional_RFI_August_2024.csv", target="_blank")),
        html.Li(html.A("September 2024 Dataset", href="assets/fractional_RFI_September_2024.csv", target="_blank")),
        html.Li(html.A("October 2024 Dataset", href="/assets/fractional_RFI_October_2024.csv", target="_blank")),
        html.Li(html.A("November 2024 Dataset", href="/assets/fractional_RFI_November_2024.csv", target="_blank")),
        html.Li(html.A("December 2024 Dataset", href="/assets/fractional_RFI_December_2024.csv", target="_blank")),
        html.Li(html.A("January 2025 Dataset", href="/assets/fractional_RFI_January_2025.csv", target="_blank")),
    ]),
